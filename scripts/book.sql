...
INSERT INTO "celsus"."book"("id", "user_id", "library_id", "title", "description", "isbn10", "isbn13", "thumbnail", "authors", "tags", "hash")
  VALUES ('1', 'user4', '6', 'Book Title', 'Book Desc', 'Book isbn10', 'Book isbn13', 'Book thumbnal', 'Book authors', 'Book tags', 'Book hash');
INSERT INTO "celsus"."book"("id", "user_id", "library_id", "title", "description", "isbn10", "isbn13", "thumbnail", "authors", "tags", "hash")
  VALUES ('2', 'user4', '6', 'Book Title', 'Book Desc', 'Book isbn10', 'Book isbn13', 'Book thumbnal', 'Book authors', 'Book tags', 'Book hash');
